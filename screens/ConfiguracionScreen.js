...
const styles = StyleSheet.create({
  ...
  ayuda: { color: '#9494a8', fontSize: 13, marginBottom: 16, lineHeight: 18 },
  ayudaChica: { color: '#9494a8', fontSize: 12, marginTop: 6, marginBottom: 10, lineHeight: 16 },
  ...
  empleadoInactivo: { color: '#9494a8', textDecorationLine: 'line-through' },
  empleadoEstado: { color: '#9494a8', fontSize: 13, marginTop: 4 },
