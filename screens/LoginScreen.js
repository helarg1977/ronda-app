...
const styles = StyleSheet.create({
  imagenSuperiorContenedor: { width: '100%', height: 370, backgroundColor: '#14141f' },
  ...
  olvidoTexto: { color: '#a0a0b0', fontSize: 13, textAlign: 'right', marginTop: 8 },
  filaEnlaces: { marginTop: 14, gap: 8, alignItems: 'center' },
  diagnosticoTexto: { color: '#4a4a5a', fontSize: 9, textAlign: 'center', marginTop: 10 },
  enlaceTexto: { color: '#a0a0b0', fontSize: 13, textAlign: 'center' },
